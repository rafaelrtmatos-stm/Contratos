...
export function generateContractTags(contract: ContractData): TagMapping {
  ...
  if (contract.tipo === 'exclusividade') {
    ...
    Object.assign(tags, {
      ...
      finalidade_exclusividade: ex.FINALIDADE_EXCLUSIVIDADE,
      FINALIDADE_EXCLUSIVIDADE: ex.FINALIDADE_EXCLUSIVIDADE,
      valor_locacao_sugerido: ex.VALOR_LOCACAO_SUGERIDO,
      VALOR_LOCACAO_SUGERIDO: ex.VALOR_LOCACAO_SUGERIDO,
      valor_locacao_sugerido_extenso: ex.VALOR_LOCACAO_SUGERIDO_EXTENSO,
      VALOR_LOCACAO_SUGERIDO_EXTENSO: ex.VALOR_LOCACAO_SUGERIDO_EXTENSO,
      comissao_locacao: ex.COMISSAO_LOCACAO,
      COMISSAO_LOCACAO: ex.COMISSAO_LOCACAO,
      taxa_administracao_locacao: ex.TAXA_ADMINISTRACAO_LOCACAO,
      TAXA_ADMINISTRACAO_LOCACAO: ex.TAXA_ADMINISTRACAO_LOCACAO,
      garantias_aceitas_locacao: ex.GARANTIAS_ACEITAS_LOCACAO,
      GARANTIAS_ACEITAS_LOCACAO: ex.GARANTIAS_ACEITAS_LOCACAO,
      autorizacao_prospeccao: ex.AUTORIZACAO_PROSPECCAO,
      AUTORIZACAO_PROSPECCAO: ex.AUTORIZACAO_PROSPECCAO,
  ...
  if (contract.tipo === 'locacao') {
    ...
    Object.assign(tags, {
      ...
      // Aliases para compatibilidade total de tags
      vendedor: locTags.locador,
      vendedor_nome: locTags.locador,
      cpf_vendedor: locTags.cpf_locador,
      vendedor_cpf_cnpj: locTags.cpf_locador,
      rg_vendedor: locTags.rg_locador,
      endereco_vendedor: locTags.endereco_locador,
      vendedor_termo: 'LOCADOR(A)',

      comprador: locTags.locatario,
      comprador_nome: locTags.locatario,
      cpf_comprador: locTags.cpf_locatario,
      comprador_cpf: locTags.cpf_locatario,
      rg_comprador: locTags.rg_locatario,
      endereco_comprador: locTags.endereco_locatario,
      comprador_termo: 'LOCATÁRIO(A)',
