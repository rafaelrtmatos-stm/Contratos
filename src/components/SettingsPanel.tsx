                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                        <div className="min-w-0">
                          <div className="flex items-center gap-2">
                            ...
                            {u.role === 'admin' && <span className="text-amber-700 font-semibold text-[11px]">Admin</span>}
                          </div>
                          <p className="text-[11px] text-slate-500 mt-0.5">
                            Cadastrado em {new Date(u.criadoEm).toLocaleDateString('pt-BR')} • Último acesso:{' '}
                            {formatUltimoAcesso(u.ultimoLogin)}
                          </p>
                        </div>
