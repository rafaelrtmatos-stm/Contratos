                ...
                <div className="space-y-3">
                  <div className="p-3.5 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      onClick={() => setActiveFlow('contratante')}
                      className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg text-xs transition-colors cursor-pointer"
                    >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 text-sm rounded-lg border border-slate-300 focus:ring-2 focus:ring-blue-500 min-h-[44px]"
                      />
                    ...
                    {contratadoDrawMode === 'draw' ? (
                      ...
                      <div className="border border-slate-300 rounded-xl p-3 bg-slate-50 space-y-3">
                        <input
                          ...
                          className="w-full px-3 py-2 text-sm rounded-lg border border-slate-300 bg-white focus:ring-2 focus:ring-blue-500 min-h-[44px]"
                        />
                  ...
                  <div className="pt-2 flex justify-end">
                    <button
                      ...
                      className="flex items-center gap-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg shadow-sm text-sm transition-all cursor-pointer min-h-[44px]"
                    >
              ...
              <div className="bg-purple-50/70 p-4 rounded-xl border border-purple-200 space-y-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    readOnly
                    value={portalLink}
                    className="w-full px-3 py-1.5 text-xs rounded-lg border border-purple-200 bg-white text-slate-700 font-mono truncate"
                  />
                  <button
                    type="button"
                    onClick={handleCopyPortalLink}
                    className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-lg bg-purple-600 hover:bg-purple-700 text-white transition-colors cursor-pointer shrink-0"
                  >
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="w-full px-3.5 py-2 text-sm rounded-lg border border-slate-300 bg-white focus:ring-2 focus:ring-blue-500 min-h-[44px]"
                        />
                        <button
                          type="submit"
                          className="px-5 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-lg transition-colors cursor-pointer shrink-0 min-h-[44px]"
                        >
                          Acessar Contrato
                        </button>
                      </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center pt-2">
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-lg transition-colors cursor-pointer disabled:opacity-50 min-h-[44px]"
                      >
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="w-full px-3.5 py-2 text-center tracking-widest font-mono text-lg font-bold rounded-lg border border-slate-300 bg-white focus:ring-2 focus:ring-blue-500 min-h-[44px]"
                        />
                        <button
                          type="button"
                          onClick={() => setEnteredOtpCode(generatedOtpCode)}
                          className="px-3 py-2 text-xs font-semibold text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 rounded-lg cursor-pointer shrink-0"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center pt-2">
                      ...
                      <button
                        ...
                        className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-lg shadow-md transition-colors cursor-pointer min-h-[44px]"
                      >
