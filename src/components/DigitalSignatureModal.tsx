          ...
          {activeFlow === 'contratado' && (
            <div className="space-y-4">
              <div className="bg-amber-50/70 p-3.5 rounded-xl border border-amber-200/80 flex items-start gap-3">
                <UserCheck className="w-5 h-5 text-amber-800 shrink-0 mt-0.5" />
                ...
                <div className="space-y-3">
                  <div className="p-3.5 rounded-xl bg-amber-50 border border-amber-200 flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      onClick={() => setActiveFlow('contratante')}
                      className="px-3.5 py-1.5 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 font-bold rounded-lg text-xs transition-colors cursor-pointer shadow-xs"
                    >
                ...
                <div className="space-y-4">
                    ...
                    {contratadoDrawMode === 'draw' ? (
                      ...
                      <div className="border border-slate-300 rounded-xl p-3 bg-slate-50 space-y-3">
                        <input
                          ...
                          className="w-full px-3 py-2 text-sm rounded-lg border border-slate-300 bg-white focus:ring-2 focus:ring-amber-500/30 focus:border-amber-500 min-h-[44px]"
                        />
                  ...
                  <div className="pt-2 flex justify-end">
                    <button
                      ...
                      className="flex items-center gap-2 px-6 py-2.5 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 font-bold rounded-lg shadow-xs text-sm transition-all cursor-pointer min-h-[44px]"
                    >
              ...
              <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200 space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold rounded-lg bg-slate-800 hover:bg-slate-900 text-white transition-colors cursor-pointer shrink-0 shadow-xs"
                  >
              ...
              <div className="border border-slate-200 rounded-xl p-4 bg-slate-50/50 space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="w-full px-3.5 py-2 text-sm rounded-lg border border-slate-300 bg-white focus:ring-2 focus:ring-amber-500/30 focus:border-amber-500 min-h-[44px]"
                        />
                        <button
                          type="submit"
                          className="px-5 py-2 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 font-bold text-xs rounded-lg transition-colors cursor-pointer shrink-0 min-h-[44px] shadow-xs"
                        >
                          Acessar Contrato
                        </button>
                      </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center pt-2">
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 font-bold text-xs rounded-lg transition-colors cursor-pointer disabled:opacity-50 min-h-[44px] shadow-xs"
                      >
                ...
                {contratanteStep === 3 && (
                  <form onSubmit={handleVerifyOtp} className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="w-full px-3.5 py-2 text-center tracking-widest font-mono text-lg font-bold rounded-lg border border-slate-300 bg-white focus:ring-2 focus:ring-amber-500/30 focus:border-amber-500 min-h-[44px]"
                        />
                        <button
                          type="button"
                          onClick={() => setEnteredOtpCode(generatedOtpCode)}
                          className="px-3 py-2 text-xs font-semibold text-amber-950 bg-amber-100 hover:bg-amber-200 border border-amber-300 rounded-lg cursor-pointer shrink-0"
                    ...
                    <div className="flex justify-between items-center pt-2">
                      ...
                      <button
                        type="submit"
                        className="px-5 py-2.5 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 font-bold text-xs rounded-lg transition-colors cursor-pointer min-h-[44px] shadow-xs"
                      >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center pt-2">
                      ...
                      <button
                        ...
                        className="px-6 py-2.5 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 font-bold text-xs rounded-lg shadow-xs transition-colors cursor-pointer min-h-[44px]"
                      >
                ...
                {contratanteStep === 5 && (
                  <div className="p-4 bg-amber-50 border border-amber-200 rounded-xl space-y-3 text-center">
                    ...
                    <div>
                      <h4 className="font-bold text-amber-950 text-sm">Contrato 100% Assinado Digitalmente!</h4>
                    ...
                    <div className="flex items-center justify-center gap-3 pt-2">
                      <button
                        ...
                        className="flex items-center gap-1.5 px-4 py-2 bg-amber-500 hover:bg-amber-400 active:bg-amber-600 text-slate-950 font-bold text-xs rounded-lg shadow-xs transition-all cursor-pointer min-h-[40px]"
                      >
