          ...
          {!generatedLink ? (
            ...
            <>
              ...
              <div className="bg-slate-50 rounded-lg p-3 space-y-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    value={generatedLink || ''}
                    readOnly
                    className="flex-1 px-3 py-2 border border-slate-300 rounded-xl text-xs bg-white text-slate-600 font-mono"
                  />
                  <button
                    type="button"
                    onClick={handleCopyLink}
                    className="px-4 py-2 btn-gold text-slate-950 rounded-xl text-xs font-extrabold flex items-center gap-1.5 cursor-pointer transition-all shadow-xs"
                  >
                    {copied ? (
                      <>
              ...
              <button
                type="button"
                onClick={onClose}
                className="w-full px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-800 text-xs font-bold rounded-xl transition-colors cursor-pointer border border-slate-200"
              >
                Fechar
              </button>
            </>
