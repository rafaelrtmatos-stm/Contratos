    ...
    venda_vista: [
      {
        ...
        testemunhas: true,
        descricao: 'Único arquivo para as 3 modalidades: usa tags unificadas de assinatura e o bloco de testemunhas é adicionado ou removido automaticamente ao gerar o contrato, conforme a modalidade real de cada parte.',
